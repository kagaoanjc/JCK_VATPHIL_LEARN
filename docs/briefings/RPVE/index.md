...
When arriving in to Davao, it is best for you to be in between 10,000 FT and FL130 when reaching the border of the TMA or the start of the STAR. On initial contact with Kalibo Approach (RPVK_APP), report your current level.
...
??? phraseology "Phraseology"
    ...
    **RPVK_APP**: CEB919, Maintain present heading, descend 10,000, QNH 1011

    **CEB919**: Maintain present heading, descend 10,000, QNH 1011, CEB919
